...
class PlacementAlgorithmSolver(PlacementAlgorithmInterface):
    ...
    def define_placement(
        ...
        """
            Determines the placement of adapters across available servers with a theoretical approach through a solver.
        ...
        # DO SOMETHING TO FILL ADAPTERS_SERVERS
