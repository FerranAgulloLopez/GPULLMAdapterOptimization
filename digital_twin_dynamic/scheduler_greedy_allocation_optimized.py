...
class SchedulerGreedyAllocationOptimized(SchedulerGreedyAllocation):
    ...
    def __init__(
        ...
        self.waiting_requests: OrderedDictType[int, RequestGreedyAllocation] = OrderedDict()
    ...
    def run_step(self, current_time: float) -> RunningBatchGreedyAllocation:
        ...
        if self.new_arrival_since_last_step and not self.max_kv_reached and not self.max_batched_tokens_reached and not self.max_adapter_reached:
            ...
            recompute = True
        elif self.max_batched_tokens_reached and (
                self.running_batch.finished_prefill_in_last_step or self.running_batch.removed_request_in_last_step):
            recompute = True
        ...
        if recompute:
            ...
            new_running_requests: List[RequestGreedyAllocation] = []
